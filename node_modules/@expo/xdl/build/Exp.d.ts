...
declare type InitialConfig = {
    displayName?: string;
    name: string;
    [key: string]: any;
};
export declare function determineEntryPointAsync(root: string): Promise<any>;
export declare function extractAndInitializeTemplateApp(templateSpec: PackageSpec, projectRoot: string, packageManager: "yarn" | "npm" | undefined, config: InitialConfig): Promise<string>;
export declare function extractTemplateAppAsync(templateSpec: PackageSpec, targetPath: string, config: InitialConfig): Promise<string>;
...
export declare function getProjectRandomnessAsync(projectRoot: string): Promise<string | number | true | import("@expo/json-file").JSONObject | import("@expo/json-file").JSONArray>;
